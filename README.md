...
> [!IMPORTANT]
> Twitter (now X) is a webisete with private code, if they make changes probably this tool will not work, in the blog post I explain how is the process to create a tool like this.  Last update (and working): 15/09/2023
